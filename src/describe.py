...
async def k8s_describe(
    ...
    Args:
        resource_type: The type of resource to describe (e.g., pods, deployments, services)
        name: The name of the resource to describe (optional - if not provided, describes all)
        namespace: The namespace of the resource (default: default, supports custom namespaces)
        ...
        try:
            ...
            if name:
                if all_namespaces:
                    ...
                    if not resource:
                        return {"error": f"{resource_type} '{name}' not found in any namespace"}
                else:
                ...
                return {
                    ...
                    "name": name,
                    "namespace": resource.metadata.namespace if has_namespace else "none",
