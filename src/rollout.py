...
@mcp.tool()
async def k8s_rollout_status(resource_type: str, name: str, namespace: str = "default", session_id: str = None):
    """
    Get the status of a rollout for a deployment, daemonset, or statefulset.

    Args:
        resource_type: The type of resource (deployment, daemonset, statefulset).
    ...
    try:
        ...
        logger.error(f"Error in k8s_rollout_status: {exc}")
        return {"error": str(exc)}


@mcp.tool()
async def k8s_rollout_history(resource_type: str, name: str, namespace: str = "default", revision: str = None, session_id: str = None):
    """
    ...
    Args:
        ...
        name: The name of the resource.
        namespace: The namespace of the resource (default: default).
        revision: The specific revision to get. If not specified, gets all revisions.
        session_id: Kubernetes session ID for remote cluster (optional)
    ...
    try:
        ...
        logger.error(f"Error in k8s_rollout_history: {exc}")
        return {"error": str(exc)}


@mcp.tool()
async def k8s_rollout_undo(resource_type: str, name: str, namespace: str = "default", to_revision: str = None, session_id: str = None):
    """
    ...
    Args:
        ...
        name: The name of the resource.
        namespace: The namespace of the resource (default: default).
        to_revision: The revision to roll back to. If not specified, rolls back to the previous revision.
        session_id: Kubernetes session ID for remote cluster (optional)
    ...
    try:
        ...
        logger.error(f"Error in k8s_rollout_undo: {exc}")
        return {"error": str(exc)}


@mcp.tool()
async def k8s_rollout_restart(resource_type: str, name: str, namespace: str = "default", session_id: str = None):
    """
    ...
    try:
        ...
        logger.error(f"Error in k8s_rollout_restart: {exc}")
        return {"error": str(exc)}


@mcp.tool()
async def k8s_rollout_pause(resource_type: str, name: str, namespace: str = "default", session_id: str = None):
    """
    Pause a rollout for a deployment or daemonset.

    Args:
        resource_type: The type of resource (deployment, daemonset).
        name: The name of the resource.
        namespace: The namespace of the resource (default: default).
        session_id: Kubernetes session ID for remote cluster (optional)
    ...
    try:
        ...
        try:
            ...
            if resource_type.lower() == "deployment":
                ...
                return {"status": "success", "message": f"Paused rollout of {resource_type}/{name} successfully"}

            else:
                return {"error": f"resource type '{resource_type}' pause not available through API"}

        except Exception as e:
            return {"error": str(e)}
    except Exception as exc:
        logger.error(f"Error in k8s_rollout_pause: {exc}")
        return {"error": str(exc)}
